...
#       Simulation Study - Main Article - Section 3, Table 1, Scenario 1       #
################################################################################

## This script provides the code for reproducing the results of Scenario 1 of 
## the simulation study reported in Table 1, Section 3 of the Main Article.
